    ...
    <div className="department-container">
      ...
      <div className="department-content">
        ...
        >
          ...
          <i className="fa-solid fa-bars department-icon"></i><p className="title">{t("navbar.departments")}</p>
          </div>
        ...
        <div className='left-side'>
            {lang === "en" ? (
              ...
              >{department?.department_name_en}</div>
            </div>
            ):(
                 <div className="department-input-container">
              ...
              <div
                ...
                className="add-department-name"
              >{department?.department_name_ar}</div>
            </div>
            )}
            ...
            <div className="department-input-container">
              ...
              <div
                ...
                className="add-department-name"
              >{department?.number_of_employees}</div>
            </div>           
            </div>        
